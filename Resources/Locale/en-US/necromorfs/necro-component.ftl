...
ent-MobDivaderRH = разделитель
    .desc = Похож на мутировавший труп.

ent-MobDivaderLH = разделитель
    .desc = Похож на мутировавший труп.

ent-MobDivaderH = разделитель
    .desc = Похож на мутировавший труп.

ent-FloorNecroTileItemFlesh = некротический пол
    .desc = От него дурго пахнет.
...
ent-ObeliskStoper = бета001
    .desc = Прототип, созданный на основе ксеноартефактов. Останавливает некрообелиск на некоторое время. Одноразовый.

 ent-CrateObeliskStoper = сундук Бета001
    .desc = Останавливает некрообелиск на некоторое время.
ent-CrateMedicalSecure = Содержит в себе лекарство от вируса некроморфозы.
    .desc = Останавливает некрообелиск на некоторое время.
ent-SyringeExtractInfectorDead = шприц
    .desc = Шприц с неизвестной жидкостью.
ent-ZetaOneMedipen = медипен ЗетаВан
    .desc = Содержит в себе лекарство от вируса некроморфозы.

reagent-desc-zetaone = На вкус как лекарство.

entity-name-extractinfectordead = Экстракт инфектора.
reagent-desc-extractinfectordead  = Густой и розовый, пахнет отвратительно. Пробовать не стану!
entity-name-syringeextractinfectordead = Шприц.

action-name-actionunitologobelisk = Создать тентаклю
action-name-actionunitologtileSpawn = Тентакля наносит урон и замедляет.

ent-ActionNecromantArmy = призыв Слэшера.
 .desc = призыв Слэшера.
