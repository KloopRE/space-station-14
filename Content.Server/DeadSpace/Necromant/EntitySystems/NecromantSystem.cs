...
using Content.Shared.DeadSpace.Necromant;
using Content.Shared.DeadSpace.Necromant.Components;
...
namespace Content.Server.DeadSpace.Necromant.EntitySystems;
...
public sealed partial class NecromantSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<NecromantComponent, TakeGhostRoleEvent>(OnTakeGhostRole);

        InitializeAbilities();
    }

    private void OnTakeGhostRole(EntityUid uid, NecromantComponent component, TakeGhostRoleEvent args)
    {
        //INetChannel MsgChannel = default!;
